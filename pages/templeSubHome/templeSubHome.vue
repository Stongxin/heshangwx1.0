	...
	<view class="templeHome" v-if="templeData.tem_info.id">
		...
		<view class="content">
			<view class="templeInfo">
				...
				<view class="desc">
					<view :class="['msg',show? 'active' : '']">
						...
						<rich-text :nodes="templeData.tem_info.content"></rich-text>
					</view>
				</view>
			</view>
			<view class="merit" v-if="fo == 1">
				...
				<view class="items">
					<view class="item" v-for="(item,index) in customs" :key="index" @click="openForm(item)">
