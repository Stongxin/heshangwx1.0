<template>
	<view class="orderDetail">
		<view class="top">
			...
			<button v-if="isApp" class="backHome" open-type="launchApp" app-parameter="wechat"
				@error="launchAppError">返回和上</button>
		...
		<view class="contentList">
			...
			<view :class="['item',{'flex_col': item.type == 'locationimg'}]" v-for="(item,index) in orderDetail.content"
				:key="index">
				<view class="label">
					{{item.title}}
				</view>
				<view class="value">
					...
					<view class="img" v-if="item.type == 'locationimg'"
						@click="pvew($common.disposeSrc(item.value,'domain'))">
		...
		<view class="" v-if="orderDetail.content && orderDetail.content.length == 4">
